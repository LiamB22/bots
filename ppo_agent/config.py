...
reward_functions = ["dense_reward_function","sparse_reward_function"]
reward = reward_functions[0]
...
train_timesteps = train_timesteps_list[2] #change how long to train agent for
