...
rewards = {"win":100, "lose":-100, "l_positive":1, "s_positive":0.01, "s_negative":-0.01, "move_penalty":-0.1,"none":0}
...
enemy_type = enemy_types["MCTS"] #change enemy
...
train_further = True #train an existing model further
